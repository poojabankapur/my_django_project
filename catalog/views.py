...
def index(request):
    ...
    kids_book = Book.objects.filter(title__icontains='Kids').count()
...
'''def book_list_view(request):
    ...
    return  render(request,'catalog/book_list.html',context={'book_list': book})
...
class BorrowedBooksByUserListView(PermissionRequiredMixin,generic.ListView):
    ...
    template_name = 'catalog/borrowed_list_user.html'
    paginate_by = 1
